...
import com.demo.spider.crawl.Proxy_89ip;
import com.demo.spider.crawl.Proxy_ihuan;
import com.demo.spider.crawl.Proxy_kuaidaili;
import com.demo.spider.crawl.xicidaili.*;
...
//'''
    ...
    private Site site = Site.me().setRetryTimes(3).setSleepTime(1000).setTimeOut(10000)
            .setUserAgent(USER_AGENTS[9]);

    private Spider spider;

    public ProxyManager() {
        mList.add(new Proxy_66ip());
        mList.add(new Proxy_kuaidaili());
        mList.add(new Proxy_xicidaili_nn());
        mList.add(new Proxy_xicidaili_nt());
        mList.add(new Proxy_xicidaili_wn());
        mList.add(new Proxy_xicidaili_wt());
        mList.add(new Proxy_xicidaili_qq());
        mList.add(new Proxy_89ip());
        mList.add(new Proxy_ihuan());
    }
